...
class DetailRespondenSurveyTransjakartaPage extends StatefulWidget {
  const DetailRespondenSurveyTransjakartaPage({super.key});

  @override
  State<DetailRespondenSurveyTransjakartaPage> createState() =>
      _DetailRespondenSurveyTransjakartaPageState();
}

class _DetailRespondenSurveyTransjakartaPageState
    extends State<DetailRespondenSurveyTransjakartaPage> {
  int selectedTab = 0;
